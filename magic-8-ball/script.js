...
$(document).ready(function () {
    ...
    var magic8Ball = {
            ...
            askAQuestion: function askAQuestion() {
                ...
                //Randomly select index in order to select a random answer
                var answer = this.listOfAnswers[Math.floor(Math.random()
    ...
    var onClick = function () {
        ...
        setTimeout(
            function () {
                ...
                var question = this.prompt("ASK A YES/NO QUESTION!");
